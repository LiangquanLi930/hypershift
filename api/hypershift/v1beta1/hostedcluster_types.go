...
type ClusterNetworking struct {
    ...
    // ovn contains OVN-specific network configuration.
    // This configuration is only applicable when networkType is OVNKubernetes.
    // +optional
    OVN *OVNKubernetesConfig `json:"ovn,omitempty"`
}
...
// OVNIPv4Config contains IPv4-specific OVN configuration.
